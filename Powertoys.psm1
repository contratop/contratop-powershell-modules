...
# By ContratopDev
# All Rights Reserved
function Powertoys-About {clear
                               Write-Host "Acerca de:"
                               Write-Host "Modulo       : Contratop PowerToys"
                               Write-Host "Desarrollador: ContratopDev"
                               Write-Host "Organizacion : New Molecule Global"
                               Write-Host "             : Contratop Studios"
                               Write-Host "Notas        : aqui va lo absurdo y divertido"}

# PowerToys Help Page
function Powertoys-Help {clear
                           Write-Host "Mostrando ayuda para el modulo Contratop PowerToys"
                           Write-Host ""
                           Write-Host "Powertoys-Help            : Muestra esta ayuda"
                           Write-Host "Powertoys-About           : Muestra detalles de este modulo"
                           Write-Host "Powertoys-Update          : Actualiza el modulo Contratop Powertoys via internet"
                           Write-Host ""
...
# Update Package
function Powertoys-Update {wget https://raw.githubusercontent.com/contratop/contratop-powershell-modules/main/Powertoys.psm1 -OutFile 'C:\Program Files\WindowsPowerShell\Modules\Powertoys\Powertoys.psm1'
                              Write-Host "El paquete de comandos PowerToys de ContratopDev ha finalizado su actualizacion" -ForegroundColor Green
                              Write-Host ""
